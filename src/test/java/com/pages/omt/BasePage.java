...
public class BasePage {
	public static boolean ElementVisibility(By ele, int waitTime) {
	...
	public static boolean GCASHwaitForElementVisibility(By ele, int waitTime) {
		...
		try {
			...
			System.out.println("PAGE IS WAITING");
		}
	...
	/********************************************************************************************************************************/
	public static boolean waitForElementVisibility(WebElement ele, int waitTime) {
	...
	/********************************************************************************************************************************/
	public void scroll_vertical(int y_Axis) throws InterruptedException {
		Thread.sleep(500L);

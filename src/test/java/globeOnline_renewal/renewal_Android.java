...
public class renewal_Android extends SetDriver {
	private static renewal_Android RENEWALScenario = new renewal_Android();
	...
	public void RENEWALScenario() throws Exception {
		...
		common.IacceptClick();
		common.menuBar("Android");
		common.ClickonRenewalLink();
		common.Renew_LandingPage("Preprod");
		common.CTBbuttonLanding("continueCTBbutton");	
		common.insert_phoneNo("09271050040");	
		...
		//Pay page validation
		common.payPageValidation("Device","OneTimePayment","nopromoinput","viewBreakdown","noesim","Samsung Galaxy A34 5G","noPTF","noOB");
//		common.uploadPOFC();
